...
void main()
{
    vec4 _43 = texture(SPIRV_Cross_CombinedcolorTexpointSampler, in_var_TEXCOORD0);
    ...
    vec3 _70 = (_65 / (vec3(1.0) + _65)).xyz + (texture(SPIRV_Cross_CombinedbloomTexlinearSampler, in_var_TEXCOORD0).xyz * 0.60000002384185791015625);
